    ...
    return (
        <div className=" bg-gr w-3/5">
            ...
            <div className="flex flex-col mt-24 ml-44">
                ...
                <form className="flex flex-row mt-10 bg-white mb-14 rounded-xl justify-start mr-14">
                    <div className="relative py-3 px-4  ">
                        <input type="search" placeholder="Job title, or keyword" className="py-2 pl-8 rounded-lg bg-gr" />
                        <img src="search.svg" alt="Search Icon" className="absolute left-4 top-1/2 transform -translate-y-1/2 h-6 w-6" />
                    </div>
                    <div className="relative py-3 px-4 ">
                        <input type="text" placeholder="Location" className="py-2 pl-8 rounded-lg bg-gr" />
                        <img src="location.svg" alt="Location Icon" className="absolute left-4 top-1/2 transform -translate-y-1/2 h-6 w-6" />
                    </div>
                    <button type="submit" className="bg-gg text-white font-bold py-2 px-4 rounded-lg text-sm h-10 mt-3 ">Search</button>
                </form>
            </div>
        </div>
    );
