...
export default function NavSearch() {
    return (
        <div className=" bg-gr w-3/5 ">
            <nav className="flex flex-row m-10 ml-6">
            ...
            <div className="flex flex-col mt-24 ml-28">
                ...
                <form className="flex flex-row mt-10 bg-white mb-14 rounded-xl justify-start mr-14 ">
                    ...
                    <button type="submit" className="bg-gg text-white font-bold py-2 px-4 rounded-lg text-sm h-10 mt-3 ml-6 ">Search</button>
                </form>
            </div>
        </div>
    );
